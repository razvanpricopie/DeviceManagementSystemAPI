...
namespace Entities.Models
{
    ...
    public class Device
    {
        ...
        [StringLength(60, ErrorMessage = "Manufacturer can't be longer than 20 characters")]
        ...
        [StringLength(60, ErrorMessage = "Operating system version can't be longer than 10 characters")]
        public String OsVersion { get; set; }

        [Required(ErrorMessage = "Processor is required")]
        [StringLength(60, ErrorMessage = "Processor can't be longer than 15 characters")]
